...
<?php $now_role=pull_role();?>

<?php $pdo= new PDO('mysql:host=localhost;dbname=register', 'root', '');
                                            $sql='SELECT users.id, users.email, users.role, users.img, users.status, user_information.user_name,user_information.location,user_information.telephone,user_information.work,user_social_link.telegram,user_social_link.instagram,user_social_link.vk FROM users LEFT JOIN user_information ON users.id=user_information.id LEFT JOIN user_social_link ON user_information.id=user_social_link.id' ;
...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                   <?php if ($now_role['role']=='admin'){echo "<a class=\"btn btn-success\" href=\"create_user.php\">Добавить</a>";} ?>
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user['user_name'];?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                  <span class="rounded-circle profile-image d-block " style="background-image:url('upload/<?php echo $user['img'];?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1 ">
                                    <a href="page_profile.php?id=<?php echo $user['id'];?>" class="fs-xl text-truncate text-truncate-lg text-info"  aria-expanded="false">
                                         <?php echo $user['user_name'];?>
                                    </a>
                                        <?php if($now_role['role']=='admin' or $user['id']==$_SESSION['id']):?>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $user['telephone'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                ...
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $user['location'];?></address>
